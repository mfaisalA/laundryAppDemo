...
if($_POST) {
	...
	WHERE workshop_id = $workshopId AND DATE(_datetime) >= '$start_date' AND DATE(_datetime) <= '$end_date' AND appointment_status != 1 AND status = 1";
	...
	<tr><th colspan="6"> General Report</th></tr>
		...
		while ($appointment = $result->fetch_assoc()) {
			...
			$table .= '<tr>
				...
				<td><center>'.getWorkshopNameFromId($con, $appointment['workshop_id']).'</center></td>
				<td><center>'.$appointment['cus_name'].'</center></td>
