<?php
  ...
  if(isset($_POST['signinBtn'])){
    if(isset($_POST['username']) && isset($_POST['password'])){
      ...
      $sql = "SELECT * FROM users WHERE username = '$username' AND password = '$pswd_hash' ";
...
<head>
    ...
    <style type="text/css">
      body{
        background: url('../images/laundry_bg.jpg');
      }
    </style>
...
<main style="background:#cccccc88; color: #ececec; height: 800px; padding-top:5%;">
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4 signin-box">
        <h1 class="text-center" style="font-weight: bolder;"><?=constant("APP_NAME") ?></h1>
