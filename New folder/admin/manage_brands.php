    ...
    <div id="errorDiv" class="col-sm-8 col-sm-offset-2">
	  ...
	  <div class="panel panel-default">
	  	<div class="panel-heading">
	  		<a href="add_brand.php" class="btn btn-primary btn-add"><span class="fa fa-plus"></span> Add</a>
	  	...
	  	<div class="panel-body">
	  		<table class="table table-striped">
	  			...
	  			<tbody>
  				<?php
  					$sql = "SELECT * FROM vehicle_brands 
  					WHERE status = 1";
					...
					while ($row = mysqli_fetch_assoc($rs)){?>
		  			...
		  			<tr>
						...
						<ul class="list-inline">
							<li>
								<a href="edit_brand.php?brand_id=<?=$row['id'] ?>" class="btn btn-info btn-xs"><span class="fa fa-edit"></span></a>
							</li>
							<li>
