...
<?php include_once 'includes/header.php' ?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">To Be Delivered</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <?php
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
            <h3><span class="fa fa-clock-o"></span> Delivery List</h3>
        </div>
        <div class="panel-body">
            <table class="table table-bordered">
                ...
                <?php
                    ...
                    WHERE status = 1 AND appointment_status = 2 
                    ...
                    <tr>
                        ...
                        <ul class="list-inline">
                            <li>
                                <a href="?delivered_id=<?=$row['id'] ?>" class="btn btn-success btn-xs">Delivered</a>
                            </li>
                            <li>
